...
?>
	...
	<form method="POST" action="updatemedtime.php?patid=<?php echo $id; ?>">
		...
		<div class="controls">
			...
			<table class="orders-table table" style="margin-left : 14px">
				<tbody>
<tr>
...
<!--			<div class="control-group">
			...
			<div class="control-group">
                  	<label class="control-label" for="input01"></label>
                  	<div class="controls">
			From Date <input type='text' class="input-medium" placeholder="Select From Date" name="fromdate_<?php echo $med12['md_medicine_id']; ?>" id="fromdate_<?php echo $med12['md_medicine_id']; ?>">
			To Date <input type='text' class="input-medium" placeholder="Select To Date" name="todate_<?php echo $med12['md_medicine_id']; ?>" id="todate_<?php echo $med12['md_medicine_id']; ?>">
			<p><input type="radio" id="medtype_<?php echo $med12['md_medicine_id']; ?>" name="medtype_<?php echo $med12['md_medicine_id']; ?>" value="Once"> Once
			<input type="radio" id="medtype_<?php echo $med12['md_medicine_id']; ?>" name="medtype_<?php echo $med12['md_medicine_id']; ?>" value="Daily"> Daily
			<input type="radio" id="medtype_<?php echo $med12['md_medicine_id']; ?>" name="medtype_<?php echo $med12['md_medicine_id']; ?>" value="Every Couple of days"> Every Couple of days</p>
                    	</div>
                	</div>
			...
			<div class="control-group mngdisp">
                  	<div class="controls" id='TextBoxesMorng_<?php echo $med12['md_medicine_id']; ?>'>
                    	<label class="control-label" style="margin : 15px;" for="input01">Morning
			<input type='button' style="margin-left : 25px;" class="btn mngaddbtn" value='Add Morning Time' id='addButton' name="<?php echo $med12['md_medicine_id']; ?>">
			<input type='button' class="btn mngremovebtn" value='Remove Morning Time' id='removeButton' name="<?php echo $med12['md_medicine_id']; ?>"></label>
			</div></div>

			<div class="control-group aftdisp">
                  	<div class="controls" id='TextBoxesAft_<?php echo $med12['md_medicine_id']; ?>'>
                  	<label class="control-label" style="margin : 15px;" for="input01">Afternoon
			<input type='button' style="margin-left : 15px;" class="btn aftaddbtn" value='Add Afternoon Time' id='addButton' name="<?php echo $med12['md_medicine_id']; ?>">
			<input type='button' class="btn aftremovebtn" value='Remove Afternoon Time' id='removeButton' name="<?php echo $med12['md_medicine_id']; ?>"></label>
			</div></div>

			<div class="control-group evedisp">
                  	<div class="controls" id='TextBoxesEve_<?php echo $med12['md_medicine_id']; ?>'>
                  	<label class="control-label" style="margin : 15px;" for="input01">Evening
			<input type='button' style="margin-left : 25px;" class="btn eveaddbtn" value='Add Evening Time' id='addButton' name="<?php echo $med12['md_medicine_id']; ?>">
			<input type='button' class="btn everemovebtn" value='Remove Evening Time' id='removeButton' name="<?php echo $med12['md_medicine_id']; ?>"></label>
			</div></div>
