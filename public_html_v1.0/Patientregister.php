...
<!-- 			<form class="form-horizontal" action="Service/patientresponce.php?service=patinsert" method="POST" name="dd1" id="dd1"> -->
			...
			<div class="control-group">
                  	<label class="control-label" for="input01"><span style=" color : red;">*</span>User Name</label>
                  	<div class="controls">
                    	<input type="text" class="input-medium" <?php valid_check("username")?> value="<?php echo $_SESSION['values']['username']; ?>" name="username" id="username">&nbsp;&nbsp;&nbsp;<strong id="notavai"></strong><i id="notempty"></i>
                    	</div>
                	</div>
			<input type="hidden" class="input-medium" value="<?php echo $_SESSION['userid']; ?>" name="userid">
                  	...
                  	<label class="control-label" for="input01"><span style=" color : red;">*</span>First Name</label>
                  	<div class="controls">
                    	<input type="text" class="input-medium" <?php valid_check("fname")?> value="<?php echo $_SESSION['values']['fname']; ?>" name="fname" id="fname">
                    	</div>
                	</div>
			...
			<div class="control-group">
                  	...
                  	<div class="controls">
                    	...
                    	<input type="password" class="input-medium" <?php valid_check("pswd")?> name="pswd" id="pswd">
                    	                	</div>
                	</div>
                  	...
                  	<label class="control-label" for="input01"><span style=" color : red;">*</span>Confirm Password</label>
                  	<div class="controls">
                    	<input type="password" class="input-medium" <?php valid_check("cpswd")?> name="cpswd" id="cpswd">
                    	</div>
                	</div>
			...
			<div class="controls">
                ...
                <select id="select01" name="age" class="input-medium">
                    <?php load_age($_SESSION['values']['age']);?>
                  	...
                  	<label class="control-label" for="input01"><span style=" color : red;">*</span>Email</label>
                  	<div class="controls">
                    	<input type="text" class="input-medium" value="<?php echo $_SESSION['values']['email']; ?>" <?php valid_check("email")?> name="email" id="email">
                    	</div>
                	</div>
