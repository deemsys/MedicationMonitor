...
$sql11 = "SELECT * FROM tbl_relationship_details WHERE rs_relation_providerid =".$_SESSION['userid'];
...
?>
					<div class="pull-right" style="margin-right : 300px;"><h2>Quick Links</h2>
				...
				<!--<a href="appoinment.php">Define New Appointment</a><br>-->
					...
					<tbody>
						...
						<td><a href="mypatientlist.php" class="stat-column">
						<span class="number"><?php echo $count11; ?></span>
						<span>No.of Patients</span></a></td>

						<td><a href="" class="stat-column">
