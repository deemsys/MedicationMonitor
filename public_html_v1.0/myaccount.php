...
include('config.php');
	...
	$sqlmyacc = "SELECT * FROM tbl_user_details WHERE ud_user_id =".$_SESSION['userid'];
...
?>
			...
			<form class="form-horizontal" name="editmyaccount" method="POST" action="updatemyaccount.php?id=<?php echo $_SESSION['userid']; ?>">
