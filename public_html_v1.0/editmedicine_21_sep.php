...
// echo $id; exit;
	...
	$sqlmedicine = "SELECT * FROM tbl_medication_details WHERE md_medicine_id = ".$medicine_id;
...
?>
					...
					<tbody>
						<tr>
							<td>Medicine ID </td>
							<td><input type="text" name="medicineid" disabled="disabled" class="input-medium" value="<?php echo $medicinerecords['md_medicine_id']; ?>"></td>
						</tr>
