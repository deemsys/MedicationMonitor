...
$avai = mysql_num_rows($sqlremname);
 ...
 $sql12 = "SELECT * FROM tbl_user_details WHERE ud_user_id = ".$_SESSION['userid'];
$query12 = mysql_query($sql12);
$records12 = mysql_fetch_array($query12);

$provider_name = $records12['ud_username'];
