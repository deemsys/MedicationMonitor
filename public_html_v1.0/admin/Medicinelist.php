           ...
           <table class="table">
                  <thead>
                    <tr style="color : #0088CC;">
                      ...
                      <th width="250"> Medicine Image</th>
...
<?php } ?>
			...
			<a title="Edit Medicine" href="editmedicine.php?id=<?php echo $recordsmedicine['md_medication_id']; ?>" class="btn"><i class="icon-pencil"></i></a>
			<a title="Delete Medicine" href="javascript:validate(<?php echo $recordsmedicine['md_medication_id']; ?>);" class="btn"><i class="icon-trash"></i></a> </div></td>
		</tr>
<?php
		}
?>
