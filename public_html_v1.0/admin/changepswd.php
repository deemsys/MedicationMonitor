...
//  alert(n);
 ...
 <ul class="breadcrumb">
        ...
        <li class="active">Change Password</li><a href="javascript:history.go(-1);"><i class="icon-chevron-left pull-right"></i></a>
      </ul>
...
?>
			...
			<div id="global" class="tab-pane fade active in">
         		<form class="form-horizontal" action="updatechangepswd.php" method="POST" name="dd1" id="dd1">
              		<fieldset>
              		<legend>Change Password</legend>
              			<p align="right"><span style=" color : red;">*</span>Required Field Can't be blank</p>
			<div class="control-group">
                  	<label class="control-label" for="input01"><span style=" color : red;">*</span>Current Password</label>
                  	<div class="controls">
                    	<input type="password" class="input-medium" name="currpswd" id="currpswd">
                    	</div>
                	</div>

			<div class="control-group">
                  	<label class="control-label" for="input01"><span style=" color : red;">*</span>New Password</label>
                  	<div class="controls">
