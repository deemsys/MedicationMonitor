...
$patient_id = $_GET['id'];// echo $id; exit;
...
?>
 ...
 <ul class="breadcrumb">
     ...
     <a href="patientlist.php">Patient Details</a><span class="divider">/</span>
     <a href="javascript:history.go(-1);"><?php echo $patientrecords['pid_patient_username'];?><span class="divider">/</span>
...
?>
			...
			<div class="control-group">
                  	...
                  	<div class="controls">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="radio"><input type="radio" <?php if(!isset($_SESSION['values']['sex'])) $_SESSION['values']['sex']=$patientrecords['pid_patient_sex']; if($_SESSION['values']['sex']=='Male')
                                    {
                                        echo 'Checked="true"';
                                    }
                                ...
                                <label class="radio"><input type="radio" name="sex"
                                                            <?php if(!isset($_SESSION['values']['sex']))
                                                                $_SESSION['values']['sex']=$patientrecords['pid_patient_sex'];
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="select01" name="age" class="input-medium">
                              <?php if(!isset($_SESSION['values']['age'])) $_SESSION['values']['age']=$patientrecords['pid_patient_age'];load_age($_SESSION['values']['age']);?>
			...
			<?php if(!isset($_SESSION['values']['country'])) $_SESSION['values']['country']=$patientrecords['pid_patient_country'];load_country($_SESSION['values']['country']);?>
			</select>
                    	</div>
                	</div>
