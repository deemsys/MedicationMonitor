...
$username = $_POST['uname'];
	...
	$sql = "select * from tbl_admin_details where md_username = '".$username."'"; 
...
if(!isset($_SESSION['error']) && count($_SESSION['error'])<=0)
{
	...
	$sql11 = "UPDATE tbl_admin_details SET md_password = '".md5($pass)."' WHERE md_admin_id = ".$records['md_admin_id'];
...
<table width="650" border="0" cellspacing="0" cellpadding="0" align="center" style="padding:10px; border: rgb(241, 250, 252) 1px solid;">
  <tr>
    <td align="left" valign="top" style="background-color: rgb(4, 63, 87); padding:10px; border-bottom: rgb(153, 153, 153) 5px solid; "><img src="http://bephit.com/medicationmonitor/admin/assets/mail_images/logo.jpg"  alt="Medication Monitor" /></td>
  </tr>
  ...
  <tr>
    <td style="padding:10px; font-family:Arial, Helvetica, sans-serif, "Myriad Pro", Calibri; font-size:12px; color: rgb(85, 85, 85); font-weight:bold; border-bottom: rgb(204, 204, 204) 1px dotted;">Admin Control Panel : <a href="http://bephit.com/medicationmonitor/admin/">http://bephit.com/medicationmonitor/admin/</a></td>
  </tr>
  <tr>
