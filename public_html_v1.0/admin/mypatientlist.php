...
if(isset($_GET['page']))
	...
	$sqlreminder = "SELECT * FROM tbl_patient_details WHERE pid_provider_userid = '".$_SESSION['userid']."' LIMIT $start, $limit";
...
//	$sqlpatient = "SELECT * FROM tbl_patient_details WHERE pid_provider_userid = '".$_SESSION['userid']."';";
// 
