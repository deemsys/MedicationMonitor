...
<?php
	$sqlreminder = "SELECT * FROM tbl_reminder_details WHERE rd_patient_id = '".$id."' ORDER BY rd_reminder_dateandtime ASC;";
...
<?php
	...
	$sql11 = "SELECT * FROM tbl_assessment_details ORDER BY ad_assessment_name ASC";
