...
// $provider_id = $_POST['provider'];
	...
	$_SESSION['success'] = "You didn't assign any assessments";
	foreach( $assessment as $assess => $assessmentvalue )
	{
 
		$assdetail ="INSERT INTO tbl_patientassessment_details (pa_patientassessment_patname, pa_patientassessment_patid, pa_patientassessment_providerid, pa_patientassessment_assid, pa_patientassessment_status) VALUES ('".$patname."', '".$patient_id."', '0', '".$assessmentvalue."', '1');";
