...
if(isset($_GET['page']))
	...
	$sqlreminder = "SELECT * FROM tbl_patient_details ORDER BY pid_patient_date DESC LIMIT $start, $limit";
...
?>
	<tr>
		...
		<a title="Edit Patient" href="editpatient.php?id=<?php echo $recordspatient['pid_patient_id']; ?>" class="btn"><i class="icon-pencil"></i></a>
		<a title="Delete Patient" href="javascript:validate(<?php echo $recordspatient['pid_patient_id']; ?>);" class="btn"><i class="icon-trash"></i></a> </div></td>
	</tr>
<?php
	}
