...
?>
 ...
 <ul class="breadcrumb">
        ...
        <!-- class="active"-->Request Patients</li><a href="javascript:history.go(-1);"><i class="icon-chevron-left pull-right"></i></a>
      </ul>
...
if(isset($_GET['page']))
	...
	else
	{
		...
		$sqlreminder = "SELECT r.*, p.* FROM tbl_relationship_details as r , tbl_patient_details as p WHERE r.rs_relation_providerid = '".$_SESSION['userid']."' && p.pid_patient_id  = r.rs_relation_patientid AND rs_relation_status = '0' ORDER BY p.pid_patient_username ASC LIMIT $start, $limit";
