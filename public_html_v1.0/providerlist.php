...
include('config.php');
	...
	$sqlreminder = "SELECT * FROM tbl_user_details LIMIT $start, $limit";
...
?>
			<tr>
                      <td><?php echo $recordsprovider['ud_username']; ?></td>
                      <td><a href="providerdetails.php?id=<?php echo $recordsprovider['ud_user_id']; ?>"><?php echo $recordsprovider['ud_firstname']; echo " ".$recordsprovider['ud_lastname']; ?></a></td>
