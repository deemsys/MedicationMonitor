...
//    alert("vcxv");
 ...
 <div class="container">
 <ul class="breadcrumb">
        <li><a href="javascript:void(0);">Reminders</a> <span class="divider">/</span></li>
...
?>
		...
		<li>
		 <input type="checkbox" name="Medicine[]" id="<?php echo $remindermedicine['md_medicine_name']; ?>" value="<?php echo $remindermedicine['md_medicine_id']; ?>">  <?php echo $remindermedicine['md_medicine_name']; ?></li>
